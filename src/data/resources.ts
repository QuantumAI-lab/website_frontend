export interface Resource {
  ...
  image?: string; //optional image for resources otherwise icons are used
}
...
export const resources: Resource[] = [
  //books with images
  {
    ...
    category: "Books",
    level: "Advanced",
    image: "https://images.unsplash.com/photo-1532012197267-da84d127e765?q=80&w=1000&auto=format&fit=crop" // Abstract Book Image
  },
  {
    id: "2",
    ...
    category: "Books",
    level: "Intermediate",
    image: "https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?q=80&w=1000&auto=format&fit=crop" // Computer/Code Image
  },
  
  // Courses (Icons Only - No Image Provided) 
  {
    id: "4",
    title: "IBM Quantum Learning",
    description: "Official free courses from IBM covering everything from basics to hardware.",
  ...
  // TOOLS (Mixed) 
  {
    ...
    category: "Tools",
    level: "All Levels",
    image: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?q=80&w=1000&auto=format&fit=crop" // Quantum Chip Image
  },
  {
    id: "10",
    title: "Quirk",
  ...
  // COMMUNITY 
  {
    ...
    description: "A Q&A site for developers and researchers to ask technical questions.",
  ...
  },
  {
    id: "13",
    title: "IEEE Quantum",
    description: "The leading community for quantum computing professionals and engineers.",
